...
void MyScene::update () {
    if (game == true) {
        if (this->move_up) {this->player->setPos(this->player->pos().rx(), this->player->pos().ry() - this->player_speed);}
        if (this->player->pos().ry() <= 20) {this->player->setPos(this->player->pos().rx(), 21);}

        if (this->move_down) {this->player->setPos(this->player->pos().rx(), this->player->pos().ry() + this->player_speed);}
        if (this->player->pos().ry() >= 600) {this->player->setPos(this->player->pos().rx(), 599);}

        if (this->move_right) {this->player->setPos(this->player->pos().rx() + this->player_speed, this->player->pos().ry());}
        if (this->player->pos().rx() >= 1100) {this->player->setPos(1099, this->player->pos().ry());}

        if (this->move_left && this->player->pos().rx() > 0) {this->player->setPos(this->player->pos().rx() - this->player_speed, this->player->pos().ry());}
